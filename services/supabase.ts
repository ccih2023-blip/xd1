...
// استخدام متغيرات البيئة إذا وجدت (للنشر على Vercel) أو القيم الثابتة للتطوير
const supabaseUrl = process.env.SUPABASE_URL || 'https://adoeguytakweqgqtmarv.supabase.co';
const supabaseKey = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFkb2VndXl0YWt3ZXFncXRtYXJ2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk5NzE1MTYsImV4cCI6MjA4NTU0NzUxNn0.2YN8SOaMU6EXwMti26EWrnGDKUmN_r-qyJ-sxugXies';
